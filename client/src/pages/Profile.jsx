    ...
    return (
        <DashboardLayout title="Identity Portfolio">
            <div className="max-w-5xl mx-auto space-y-10">
                ...
                <AnimatePresence>
                    {message && (
                        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="p-5 bg-emerald-50 text-emerald-600 rounded-2xl text-center border border-emerald-100 font-bold tracking-tight italic">
                            {message}
                        </motion.div>
                    )}
                </AnimatePresence>
                    ...
                    <form onSubmit={handleSubmit} className="bg-white rounded-[3rem] p-12 border border-slate-100 shadow-sm space-y-12">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            {[
                                ...
                                { label: 'Active Occupation', name: 'occupation', type: 'text' },
                                { label: 'Geolocation Hub', name: 'location', type: 'text' },
                                { label: 'Native Lexicon', name: 'language', type: 'text' },
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <div className="lg:col-span-2 space-y-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <InfoBlock label="Biological Age" value={user?.age} icon={<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>} />
                                <InfoBlock label="Gender Identity" value={user?.gender} icon={<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>} />
                                <InfoBlock label="Professional Role" value={user?.occupation} icon={<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>} />
                                <InfoBlock label="Geolocation Hub" value={user?.location} icon={<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>} />
