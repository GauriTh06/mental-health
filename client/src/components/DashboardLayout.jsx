    ...
    const SidebarContent = () => (
        <div className="flex flex-col h-full bg-[#DDEBF7] border-r border-[#CBD5E1]">
            <div className="px-8 py-8 flex justify-center">
                <img src="https://res.cloudinary.com/dxen0alt5/image/upload/v1769139755/logomindwell_oo6uaw.jpg" alt="MindWell Logo" className="w-32 h-auto rounded-3xl shadow-xl shadow-slate-400/20 border-2 border-white" />
            </div>
