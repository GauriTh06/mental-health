    ...
    const SidebarContent = () => (
        <div className="flex flex-col h-full bg-[#DDEBF7] border-r border-[#CBD5E1]">
            <div className="px-8 py-8 flex justify-center">
                <img src="https://ibb.co/0yX8v95Bhttps://res.cloudinary.com/dxen0alt5/image/upload/v1769139755/logomindwell_oo6uaw.jpg" alt="MindWell Logo" className="w-32 h-auto rounded-3xl shadow-xl shadow-slate-400/20 border-2 border-white" />
            </div>
    ...
    return (
        <div className="flex h-screen bg-[#F3F7FA]">
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden dashboard-bg-container">
                ...
                <div className="flex-1 overflow-y-auto px-4 lg:px-6 py-10 space-y-12 relative z-10">
                    {children}
                </div>
            </main>
        </div>
